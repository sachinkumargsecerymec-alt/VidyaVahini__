...
public final class FragmentRoutesBinding implements ViewBinding {
  ...
  private FragmentRoutesBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView routeList,
      @NonNull TextInputEditText searchInput) {
  ...
  public static FragmentRoutesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.routeList;
      RecyclerView routeList = ViewBindings.findChildViewById(rootView, id);
      if (routeList == null) {
        break missingId;
      }
      ...
      return new FragmentRoutesBinding((LinearLayout) rootView, routeList, searchInput);
    }
